...
public class UsernameAndPasswordAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    @Autowired
    private DatabaseUsersDetailsService databaseUserDetailsService;

    public UsernameAndPasswordAuthenticationFilter(DatabaseUsersDetailsService databaseUserDetailsService) {
